...
<head>
    ...
    <link rel="icon" href="http://spjpcbsd6.hb-bkt.clouddn.com/images/favicon.ico">
    <title>秒杀抢购</title>
    <link rel="stylesheet" href="http://spjpcbsd6.hb-bkt.clouddn.com/js/layer_mobile/need/layer.css"/>
    <link rel="stylesheet" href="http://spjpcbsd6.hb-bkt.clouddn.com/css/index.css"/>
</head>
...
<div id="app">
    <header>
        ...
        <div class="detailsInfo">
            <div style="padding:8px 14px;position: relative;">
                ...
                <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/detailLog.png" class="ico" width="45" alt="">
            </div>
    ...
    <div class="skileDetail">
        <div class="itemCont infoCont">
            ...
            <div class="item">
                ...
                <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/right.png" width="44"
                     alt="">
            </div>
            <div class="item">
                <div class="info"><span>送至</span><span>北京市昌平区建材城西路9号, 传智播客前台</span></div>
                <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/right.png"
                     width="44" alt="">
            </div>
        </div>
        <div class="itemCont comment">
            <div class="title">
                ...
                <div class="rit">
                    <span>好评度 100%</span>
                    <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/right.png" width="44" alt="">
                </div>
            </div>
            <div class="cont">
                <div class="item">
                    <div class="top">
                        <div class="info">
                            <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/icon.png" width="25" height="25" alt=""/>
                            <div style="color:#666;margin-left: 10px; font-size: 14px;">张庆</div>
                        </div>
                        <div>
                            <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/shoucang.png" width="11" alt="">
                            <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/shoucang.png" width="11" alt="">
                            <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/shoucang.png" width="11" alt="">
                            <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/shoucang.png" width="11" alt="">
                            <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/shoucang.png" width="11" alt="">
                    ...
                    <div class="des">
                        ...
                        <div style="margin: 10px 0">
                            <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/detail1.png" width="79" height="79" style="border-radius: 3px;"/>
                            <img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/detail2.png" width="79" height="79" style="border-radius: 3px;"/>
                        </div>
                        <div class="font">
    ...
    <footer>
        <div class="collection">
            <span><img src="http://spjpcbsd6.hb-bkt.clouddn.com/images/shoucang.png" width="21" alt=""></span>
            <span>收藏</span>
        </div>
...
<!-- 引入组件库 -->
<script type="text/javascript" src="http://spjpcbsd6.hb-bkt.clouddn.com/js/jquery-3.6.0.min.js"></script><!-- axios交互-->
<script type="text/javascript" src="http://spjpcbsd6.hb-bkt.clouddn.com/js/axios.js"></script><!-- axios交互-->
<script src="http://spjpcbsd6.hb-bkt.clouddn.com/js/layer_mobile/layer.js"></script>
<script>
    // 商品id
    var id = '${sku.id}';
    // 登录token
...
<script src="http://spjpcbsd6.hb-bkt.clouddn.com/js/index.js"></script>
</body>
